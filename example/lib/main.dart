...
class _MyHomePageState extends State<MyHomePage> {
  List<AppBarStyle> _styles = [
    AppBarStyle(null, Colors.amber, null),
    AppBarStyle(Colors.pink[50], Colors.green, 60),
    AppBarStyle(Colors.green[100], Colors.purple, 72),
    AppBarStyle(Colors.red, Colors.cyan, null),
    AppBarStyle(Colors.amber, Colors.white, null),
  ];
